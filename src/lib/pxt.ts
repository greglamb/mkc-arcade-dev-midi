...
export function inflateSong(song: Song) {
...
export function getSongInfo(song: Song): SongInfo {
    return {
...
export function getEmptySong(measures: number): Song {
    return {
        ticksPerBeat: 8,
        beatsPerMeasure: 4,
        beatsPerMinute: 120,
